<?php $this->assign('title', 'Danh sách làm thêm đã phê duyệt'); ?>
<section class="content-header">
    <h1>
        Làm thêm giờ đã phê duyệt
    </h1>
    <ol class="breadcrumb">
        <li><?= $this->Html->link('<i class="fa fa fa-home"></i> Trang chủ</a>', '/', ['escape' => false]) ?></li>
        <li class="active">Làm thêm giờ (Đã phê duyệt)</li>
    </ol>
</section>
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Danh sách làm thêm đã phê duyệt</h3>
        </div>
        <!-- /.box-header -->
